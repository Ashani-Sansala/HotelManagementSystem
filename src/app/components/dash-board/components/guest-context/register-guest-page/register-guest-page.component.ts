...
@Component({
  selector: 'app-register-guest-page',
  templateUrl: './register-guest-page.component.html',
  styleUrls: ['./register-guest-page.component.scss']
})
export class RegisterGuestPageComponent implements OnInit {
  ...
  uploadData(){
    ...
    this._guestService.registerGuest(dto).subscribe(response => {
